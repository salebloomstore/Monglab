...
rs.initiate({
  ...
  members: [
    {
      _id: 0,
      host: process.env.SHARDE_EVERES_DN_ADRS + ":" + process.env.PORT_OF_MONGOS,
      priority: 2
    },
    {
      _id: 1,
      host: process.env.SHARDE_EVERES_HN_ADRS + ":" + process.env.PORT_OF_MONGOS,
      priority: 1
    },
    {
      _id: 2,
      host: process.env.SHARDE_EVERES_SG_ADRS + ":" + process.env.PORT_OF_MONGOS,
      priority: 1
    }
  ]
})
