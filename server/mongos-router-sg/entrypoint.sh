...
mongos --configdb matterRS/${SHARDE_MATTER_SG_ADRS}:${SHARDE_MATTER_SG_PORT_OF},${SHARDE_MATTER_SG_ADRS}:${SHARDE_MATTER_SG_PORT_OF},${SHARDE_MATTER_SG_ADRS}:${SHARDE_MATTER_SG_PORT_OF} --bind_ip_all --port ${MONGOS_ROUTER_SG_PORT_OF} --keyFile /etc/mongo-keyfile --fork --logpath /tmp/mongod.log
